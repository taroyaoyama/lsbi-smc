...
class Uniform:
    ...
    def values(self, n = None):
        if self._values is None:
            raise ValueError("Error: self.values is not initialized. Call sample() before accessing values.")
...
class Normal:
    ...
    def values(self, n = None):
        if self._values is None:
            raise ValueError(f"Error: self.values is not initialized. Call sample() before accessing values.")
        if n is not None and len(self._values) != n:
            raise ValueError(f"Error: Expected {n} samples, but got {len(self._values)}.")
        return self._values
...
class Laplace:
    ...
    def values(self, n = None):
        ...
        if n is not None and len(self._values) != n:
            raise ValueError(
                f"Error: Expected {n} samples, but got {len(self._values)}."
            )
        return self._values
